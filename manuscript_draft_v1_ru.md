...
## Аннотация
Современное потепление атмосферного воздуха в Канадском Арктическом архипелаге ускорило истончение и отступавание ледниковых куполов Баффиновой Земли. В данном исследовании мы используем профили воздушного радиолокационного зондирования 2-го уровня (MCoRDS), полученные в рамках кампаний NASA Operation IceBridge в период с 2013 по 2017 год, для оценки пространственно-временной динамики ледникового купола Пенни. Для устранения систематических геодезических вертикальных смещений датумов (в диапазоне от $-28,8$ м до $-45,8$ м) между различными годами кампаний мы представляем алгоритм калибровки по подледному ложу, использующий стабильное ложе в качестве статической геодезической опорной поверхности. Наш откалиброванный многовременной анализ показывает медианное опускание поверхности ледникового купола на $-1,178$ метра в период с 2013 по 2017 год (скорость абляции примерно $-0,294$ м/год), в то время как медианная толщина льда оставалась относительно стабильной (изменение $+1,481$ м). Сравнение профиля MCoRDS 2017 года с канадской цифровой моделью рельефа высокого разрешения (HRDEM) выявляет систематическое смещение датума $+21,15$ м (эллипсоидальные высоты WGS84 против ортометрических высот CGVD2013) и подтверждает, что тайл HRDEM Cumberland Peninsula соответствует мозаике спутниковых снимков ArcticDEM 2015–2016 годов, а не снимку 2022 года. Наконец, мы моделируем вертикальный профиль скорости льда в приближении мелкого льда (SIA) с использованием закона течения Глена. Включение мягкого базального слоя плейстоценового льда (PIL) с коэффициентом увеличения текучести ($E = 3,5$) показывает, что деформация сдвига сильно концентрируется в нижних 12% ледяной толщи, увеличивая скорость скольжения и указывая на то, что базальная стратиграфия льда играет ключевую роль в регуляции реакции ледника на потепление климата.
